...
const CONFIG_FILE = path.join(OUTPUT_DIR, 'config-relationships.json');
const MADGE_FILE = path.join(OUTPUT_DIR, 'raw-madge.json');
const OUTPUT_FILE = path.join(OUTPUT_DIR, 'integration-flows.json');
