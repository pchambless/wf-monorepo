...
flowchart LR
  ...
  subgraph PLANS
    planList["page:CrudLayout<br>planList<br>[:]"]
    SelPlan["ui:Selector<br>SelPlan<br>[:]"]
    planCommunicationList["page:CrudLayout<br>planCommunicationList<br>[::planID]"]
    planImpactList["page:CrudLayout<br>planImpactList<br>[::planID]"]
    planDocumentList["page:CrudLayout<br>planDocumentList<br>[::planID]"]
    planDetail["api:query<br>planDetail<br>[::planID]"]
    plansByStatus["api:query<br>plansByStatus<br>[::status]"]
    fetchCommunication["api:query<br>fetchCommunication<br>[::communicationID]"]
  end
  ...
  class planList page:CrudLayout;
  class SelPlan ui:Selector;
  class planCommunicationList page:CrudLayout;
  class planImpactList page:CrudLayout;
  class planDocumentList page:CrudLayout;
  class planDetail api:query;
  class plansByStatus api:query;
  class fetchCommunication api:query;
  ...
  classDef ui:Selector fill:#f0f0f0,stroke:#333,stroke-width:1px,color:#000;
