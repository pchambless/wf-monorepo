...
--
-- Table structure for table `apiColumns`
--

DROP TABLE IF EXISTS `apiColumns`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `apiColumns` (
  `id` int NOT NULL AUTO_INCREMENT,
  `parentID` int NOT NULL DEFAULT '0',
  `variableName` varchar(50) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `clone_session`
--

DROP TABLE IF EXISTS `clone_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `clone_session` (
  ...
  `current_step` enum('init','hierarchy','components','props','triggers','eventSQL','ready','committed') COLLATE utf8mb4_general_ci DEFAULT 'init',
  `status` enum('in_progress','paused','ready_to_commit','committed','failed') COLLATE utf8mb4_general_ci DEFAULT 'in_progress',
  `template_hierarchy` json DEFAULT NULL,
  `staged_components` json DEFAULT NULL,
  `staged_props` json DEFAULT NULL,
  `staged_triggers` json DEFAULT NULL,
  `staged_eventsql` json DEFAULT NULL,
  ...
  CONSTRAINT `clone_session_ibfk_1` FOREIGN KEY (`template_id`) REFERENCES `page_registry` (`id`),
  CONSTRAINT `clone_session_ibfk_2` FOREIGN KEY (`target_id`) REFERENCES `page_registry` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `clone_xref_mapping`
--

DROP TABLE IF EXISTS `clone_xref_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `clone_xref_mapping` (
  `id` int NOT NULL AUTO_INCREMENT,
  `source_page_id` int NOT NULL,
  `target_page_id` int NOT NULL,
  `source_xref_id` int NOT NULL,
  `target_xref_id` int NOT NULL,
  `comp_name` varchar(30) DEFAULT NULL,
  `comp_type` varchar(30) DEFAULT NULL,
  `old_parent_id` int DEFAULT NULL,
  `posOrder` varchar(25) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Paul',
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `deleted_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_source_target` (`source_page_id`,`target_page_id`),
  KEY `idx_source_xref` (`source_xref_id`),
  KEY `idx_target_xref` (`target_xref_id`)
...
--
-- Table structure for table `eventComp_xref`
--

DROP TABLE IF EXISTS `eventComp_xref`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eventComp_xref` (
  ...
  CONSTRAINT `eventComp_xref_comp_type_FK` FOREIGN KEY (`comp_type`) REFERENCES `eventType` (`name`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_eventComp_xref_composite` FOREIGN KEY (`composite_id`) REFERENCES `eventComposite` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `eventComposite`
--

DROP TABLE IF EXISTS `eventComposite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eventComposite` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `eventPageConfig`
--

DROP TABLE IF EXISTS `eventPageConfig`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eventPageConfig` (
  `id` int NOT NULL AUTO_INCREMENT,
  `pageID` int NOT NULL,
  ...
  `active` tinyint(1) GENERATED ALWAYS AS ((case when (`deleted_at` is null) then 1 else 0 end)) STORED,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_page_component` (`pageID`,`xref_id`),
  KEY `idx_pageID` (`pageID`),
  KEY `idx_xref_id` (`xref_id`),
  KEY `idx_active` (`active`),
  CONSTRAINT `eventPageConfig_ibfk_1` FOREIGN KEY (`pageID`) REFERENCES `page_registry` (`id`),
  CONSTRAINT `eventPageConfig_ibfk_2` FOREIGN KEY (`xref_id`) REFERENCES `eventComp_xref` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `eventProps`
--

DROP TABLE IF EXISTS `eventProps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eventProps` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `eventProps_eventComp_xref_FK` FOREIGN KEY (`xref_id`) REFERENCES `eventComp_xref` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=160 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `eventSQL`
--

DROP TABLE IF EXISTS `eventSQL`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `eventTrigger` (
  ...
  KEY `idx_xref_page` (`xref_id`,`pageID`),
  CONSTRAINT `eventTrigger_eventComp_xref_FK` FOREIGN KEY (`xref_id`) REFERENCES `eventComp_xref` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
--
-- Temporary view structure for view `vw_eventComp_xref`
--

DROP TABLE IF EXISTS `vw_eventComp_xref`;
/*!50001 DROP VIEW IF EXISTS `vw_eventComp_xref`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_eventComp_xref` AS SELECT 
 1 AS `xref_id`,
 1 AS `pageID`,
 1 AS `parent_id`,
 1 AS `pageName`,
 ...
 1 AS `comp_type`,
 1 AS `posOrder`,
 1 AS `override_styles`,
 1 AS `description`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_eventComponent`
--

DROP TABLE IF EXISTS `vw_eventComponent`;
/*!50001 DROP VIEW IF EXISTS `vw_eventComponent`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_eventComponent` AS SELECT 
 1 AS `name`,
 1 AS `title`,
 1 AS `category`,
 1 AS `purpose`,
...
--
-- Temporary view structure for view `vw_eventContainer`
--

DROP TABLE IF EXISTS `vw_eventContainer`;
/*!50001 DROP VIEW IF EXISTS `vw_eventContainer`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_eventContainer` AS SELECT 
 1 AS `name`,
 1 AS `title`,
 1 AS `category`,
 1 AS `purpose`,
...
--
-- Temporary view structure for view `vw_eventProps`
--

DROP TABLE IF EXISTS `vw_eventProps`;
/*!50001 DROP VIEW IF EXISTS `vw_eventProps`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_eventProps` AS SELECT 
 1 AS `prop_id`,
 1 AS `pageID`,
 1 AS `pageName`,
 1 AS `xref_id`,
...
--
-- Temporary view structure for view `vw_eventSQL`
--

DROP TABLE IF EXISTS `vw_eventSQL`;
/*!50001 DROP VIEW IF EXISTS `vw_eventSQL`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_eventSQL` AS SELECT 
 1 AS `xref_id`,
 1 AS `pageName`,
 1 AS `comp_name`,
 1 AS `comp_type`,
...
--
-- Temporary view structure for view `vw_eventTrigger`
--

DROP TABLE IF EXISTS `vw_eventTrigger`;
/*!50001 DROP VIEW IF EXISTS `vw_eventTrigger`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_eventTrigger` AS SELECT 
 1 AS `trigger_id`,
 1 AS `pageID`,
 1 AS `xref_id`,
 1 AS `pageName`,
...
--
-- Temporary view structure for view `vw_hier_components`
--

DROP TABLE IF EXISTS `vw_hier_components`;
/*!50001 DROP VIEW IF EXISTS `vw_hier_components`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_hier_components` AS SELECT 
 1 AS `xref_id`,
 1 AS `pageID`,
 1 AS `parent_id`,
 1 AS `pageName`,
...
--
-- Temporary view structure for view `vw_pageComponents`
--

DROP TABLE IF EXISTS `vw_pageComponents`;
/*!50001 DROP VIEW IF EXISTS `vw_pageComponents`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_pageComponents` AS SELECT 
 1 AS `xref_id`,
 1 AS `pageID`,
 1 AS `comp_name`,
 1 AS `comp_type`,
...
--
-- Final view structure for view `vw_eventComp_xref`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_eventComp_xref` AS select `x`.`id` AS `xref_id`,`x`.`pageID` AS `pageID`,`x`.`parent_id` AS `parent_id`,`b`.`pageName` AS `pageName`,`api_wf`.`f_xrefParent`(`x`.`parent_id`) AS `parent_name`,`x`.`comp_name` AS `comp_name`,concat(`api_wf`.`f_xrefParent`(`x`.`parent_id`),'.',`x`.`comp_name`) AS `parentCompName`,`x`.`title` AS `title`,`x`.`comp_type` AS `comp_type`,`x`.`posOrder` AS `posOrder`,`x`.`style` AS `override_styles`,`x`.`description` AS `description` from (`eventComp_xref` `x` join `page_registry` `b` on((`x`.`pageID` = `b`.`id`))) where (`x`.`active` = 1) order by `b`.`pageName`,`api_wf`.`f_xrefParent`(`x`.`parent_id`),`x`.`comp_name`,`x`.`posOrder` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_eventComponent`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_eventComponent` AS select `a`.`name` AS `name`,`a`.`title` AS `title`,`a`.`category` AS `category`,`a`.`purpose` AS `purpose`,`a`.`style` AS `style` from `eventType` `a` where (`a`.`category` = 'component') order by `a`.`name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_eventContainer`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_eventContainer` AS select `a`.`name` AS `name`,`a`.`title` AS `title`,`a`.`category` AS `category`,`a`.`purpose` AS `purpose`,`a`.`style` AS `style` from `eventType` `a` where (`a`.`category` = 'container') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_eventProps`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_eventProps` AS select `a`.`id` AS `prop_id`,`a`.`pageID` AS `pageID`,`pr`.`pageName` AS `pageName`,`a`.`xref_id` AS `xref_id`,coalesce(`b_template`.`comp_type`,`b_own`.`comp_type`) AS `comp_type`,coalesce(`b_template`.`comp_name`,`b_own`.`comp_name`) AS `comp_name`,`a`.`paramName` AS `paramName`,`a`.`paramVal` AS `paramVal`,coalesce(`b_template`.`parent_id`,`b_own`.`parent_id`) AS `parent_id` from (((`eventProps` `a` left join `vw_hier_components` `b_template` on(((`a`.`xref_id` = `b_template`.`xref_id`) and (`b_template`.`pageID` = 11)))) left join `vw_hier_components` `b_own` on(((`a`.`xref_id` = `b_own`.`xref_id`) and (`a`.`pageID` = `b_own`.`pageID`)))) left join `page_registry` `pr` on((`a`.`pageID` = `pr`.`id`))) order by `a`.`pageID`,`a`.`xref_id`,`a`.`paramName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_eventSQL`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_eventSQL` AS select `a`.`xref_id` AS `xref_id`,`a`.`pageName` AS `pageName`,`a`.`comp_name` AS `comp_name`,`a`.`comp_type` AS `comp_type`,`c`.`qryName` AS `qryName`,`b`.`qryName` AS `qryTrigger`,`c`.`qrySQL` AS `qrySQL`,`a`.`pageID` AS `pageID` from ((`vw_eventProps` `a` left join (select `eventTrigger`.`xref_id` AS `xref_id`,`eventTrigger`.`content` AS `qryName` from `eventTrigger` where (`eventTrigger`.`action` = 'execEvent')) `b` on((`a`.`xref_id` = `b`.`xref_id`))) left join `eventSQL` `c` on((replace(`b`.`qryName`,'{{pageConfig.pageName}}',`a`.`pageName`) = `c`.`qryName`))) where ((`c`.`id` is not null) and (`a`.`comp_name` in ('Grid','Form'))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_eventTrigger`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_eventTrigger` AS select `a`.`id` AS `trigger_id`,`a`.`pageID` AS `pageID`,`a`.`xref_id` AS `xref_id`,coalesce(`b_template`.`pageName`,`b_own`.`pageName`) AS `pageName`,coalesce(`b_template`.`comp_name`,`b_own`.`comp_name`) AS `comp_name`,coalesce(`b_template`.`comp_type`,`b_own`.`comp_type`) AS `comp_type`,`a`.`ordr` AS `ordr`,`a`.`class` AS `class`,`a`.`action` AS `action`,coalesce(`b_template`.`parent_id`,`b_own`.`parent_id`) AS `parent_id`,`e`.`api_id` AS `api_id`,`e`.`wrkFlow_id` AS `wrkFlow_id`,`e`.`controller_id` AS `controller_id`,`d`.`is_dom_event` AS `is_dom_event`,`a`.`content` AS `content` from ((((`eventTrigger` `a` left join `vw_hier_components` `b_template` on(((`a`.`xref_id` = `b_template`.`xref_id`) and (`b_template`.`pageID` = 11)))) left join `vw_hier_components` `b_own` on(((`a`.`xref_id` = `b_own`.`xref_id`) and (`a`.`pageID` = `b_own`.`pageID`)))) join `triggers` `d` on((`a`.`class` = `d`.`name`))) join `triggers` `e` on((`a`.`action` = `e`.`name`))) order by `a`.`pageID`,coalesce(`b_template`.`parent_id`,`b_own`.`parent_id`),`a`.`xref_id`,`a`.`ordr` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_hier_components` AS select `x`.`id` AS `xref_id`,`x`.`pageID` AS `pageID`,`x`.`parent_id` AS `parent_id`,`b`.`pageName` AS `pageName`,`api_wf`.`f_xrefParent`(`x`.`parent_id`) AS `parent_name`,`x`.`comp_name` AS `comp_name`,concat(`api_wf`.`f_xrefParent`(`x`.`parent_id`),'.',`x`.`comp_name`) AS `parentCompName`,`x`.`title` AS `title`,`x`.`comp_type` AS `comp_type`,`x`.`posOrder` AS `posOrder`,`x`.`style` AS `override_styles`,`x`.`description` AS `description` from (`eventComp_xref` `x` join `page_registry` `b` on((`x`.`pageID` = `b`.`id`))) where (`x`.`active` = 1) order by `b`.`pageName`,`api_wf`.`f_xrefParent`(`x`.`parent_id`),`x`.`comp_name`,`x`.`posOrder` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `vw_pageComponents`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`wf_admin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_pageComponents` AS select `x`.`id` AS `xref_id`,`x`.`pageID` AS `pageID`,`x`.`comp_name` AS `comp_name`,`x`.`comp_type` AS `comp_type`,`x`.`parent_id` AS `parent_id`,`x`.`title` AS `title`,`x`.`description` AS `description`,`x`.`posOrder` AS `posOrder`,`x`.`style` AS `override_styles`,coalesce(`p`.`props`,'{}') AS `props`,coalesce(`p`.`triggers`,'[]') AS `triggers` from (`eventComp_xref` `x` left join `eventPageConfig` `p` on(((`x`.`id` = `p`.`xref_id`) and (`x`.`pageID` = `p`.`pageID`)))) where (`x`.`active` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-16 12:34:54
