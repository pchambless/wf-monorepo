...
import pageMap from '@whatsfresh/shared-config/src/pageMap/rcpeList';
...
const log = createLogger('Product Recipes');

const rcpeListPage = observer(() => {
  useEffect(() => {
    ...
    if (navigationStore.parentId) {
      navigationStore.setBreadcrumbs([
        ...
        { label: 'Product Recipes', path: null }
      ]);
    } else {
      navigationStore.setBreadcrumbs([
        { label: 'Product Recipes', path: null }
