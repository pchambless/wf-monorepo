...
import pageMap from '@whatsfresh/shared-config/src/pageMap/measList';
import dataStore from '@stores/dataStore';
import navigationStore from '@stores/navigationStore';
import createLogger from '@utils/logger';

const log = createLogger('Measures');

const measListPage = observer(() => {
  useEffect(() => {
    log.debug('measListPage component mounted');
    ...
    if (pageMap.systemConfig?.listEvent) {
      ...
      log.warn('No listEvent configured for measListPage');
    }
  }, []);
