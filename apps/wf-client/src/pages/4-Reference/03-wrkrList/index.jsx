...
import pageMap from '@whatsfresh/shared-config/src/pageMap/wrkrList';
...
const wrkrListPage = observer(() => {
  useEffect(() => {
    log.debug('wrkrListPage component mounted');
    ...
    if (pageMap.systemConfig?.listEvent) {
      ...
      log.warn('No listEvent configured for wrkrListPage');
    }
  }, []);
