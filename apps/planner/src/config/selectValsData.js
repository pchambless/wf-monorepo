...
export const selectVals = {
  ...
  planStatus: {
    name: "planStatus",
    description: "Available plan statuses for filtering and management",
    choices: [
      { value: "pending", label: "Pending", ordr: 1, color: "orange" },
      { value: "active", label: "Active", ordr: 2, color: "blue" },
      { value: "completed", label: "Completed", ordr: 3, color: "green" },
      { value: "archived", label: "Archived", ordr: 4, color: "gray" }
    ]
  },
