...
import { getCategoryOptions } from '../config/componentCategories.js';
...
const ComponentDetailCard = () => {
  ...
  const loadRealEventTypeData = async (eventTypeName) => {
    ...
    try {
      const { getVal } = await import('../stores/contextStore');
      ...
      console.log('✅ Loaded real eventType data via discovery:', eventTypeData);
  ...
  const handleEventTypeUpdate = (updatedData) => {
    console.log('🔄 ComponentDetailCard - EventType updated:', updatedData);
    ...
    <div className="component-detail-container">
      ...
      <div className="component-detail-cards">
        ...
        <div className="actions-card full-width-card">
          <h5 className="actions-title">⚙️ Actions</h5>
