CREATE TABLE IF NOT EXISTS triggers (
  id int NOT NULL AUTO_INCREMENT,
    ...
    htmx_verb varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
    endpoint varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
    ...
    PRIMARY KEY (id),
    UNIQUE KEY triggers_unique (trigType,name)
