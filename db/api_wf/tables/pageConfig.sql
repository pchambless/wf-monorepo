CREATE TABLE IF NOT EXISTS pageConfig (
  id int NOT NULL AUTO_INCREMENT,
    ...
    KEY fk_pageConfig_composite (composite_id),
    CONSTRAINT fk_pageConfig_composite FOREIGN KEY (composite_id) REFERENCES composites (id),
