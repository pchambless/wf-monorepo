...
LEFT JOIN (select wf_prodBtchIngrDtl.product_batch_id AS product_batch_id,
wf_prodBtchIngrDtl.product_recipe_id AS product_recipe_id,
json_arrayagg(wf_prodBtchIngrDtl.ingrBtchSrce) AS ingrMaps from wf_prodBtchIngrDtl
GROUP BY wf_prodBtchIngrDtl.product_batch_id,
